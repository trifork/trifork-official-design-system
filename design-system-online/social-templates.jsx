...
function DefaultContent({ format, layout, pad, eyebrow, eyebrowColor, title, titleColor, titleSizeOverride, body, meta, metaRows, positions, metaColor, showLogo, bg, onDark, variant }) {
...
function EventContent({ format, layout, pad, eyebrow, eyebrowColor, title, titleColor, titleSizeOverride, meta, metaRows, metaColor, showLogo, bg, onDark, speakers }) {
  const ebSize = format === '1.91:1' ? 16 : format === '9:16' ? 32 : 24;
...
/* ---------- QuoteContent ---------- */
function QuoteContent({ format, layout, pad, eyebrow, eyebrowColor, title, titleColor, titleSizeOverride, attribution, metaColor, showLogo, bg, onDark }) {
  const ebSize = format === '1.91:1' ? 16 : format === '9:16' ? 32 : 24;
...
Object.assign(window, {
  SocialPost, Eyebrow, Title, Body, Meta, MetaRows, PositionsList, Avatar, SpeakerList, Logo,
  FORMATS, TITLE_SIZES, TITLE_BREAKPOINTS, pickTitleSize, paddingFor,
});
