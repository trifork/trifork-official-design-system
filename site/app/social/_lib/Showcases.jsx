/* =============================================================
   Trifork — Social showcases (gallery, anatomy, layouts, formats, ...)
   ============================================================= */

import { SocialPost, FORMATS } from "./SocialPost";
import { TEMPLATE_PRESETS, CAROUSEL_EXAMPLE } from "./presets";
...
export function Gallery() {
  return <div>{TEMPLATE_PRESETS.map((p, i) => <TemplateRow key={i} preset={p} />)}</div>;
}
...
export function TitleSizingDemo() {
  const SCALE = 0.22;
  const dims = FORMATS["1:1"];
  const cases = [
